...
QtObject {
    ...
    readonly property var jaText: ({
        ...
        "下载完成时保持安静": "ダウンロード完了時は通知音を鳴らしません",
        "下载完成时播放提示音": "ダウンロード完了時に通知音を鳴らします",
        "下载": "ダウンロード",
        "下载中": "ダウンロード中",
        "下载任务": "ダウンロード",
        "下载设置": "ダウンロード設定",
        ...
        "等待下载": "ダウンロード待機中",
        "已删除": "削除済み",
        "本地文件已删除": "ローカルファイルは削除されました",
        "等待可用下载槽": "利用可能なダウンロード枠を待機中",
        "并行下载任务": "同時ダウンロード",
        "动态并行块": "動的並列ブロック",
        "自动调整": "自動調整",
        "固定队列": "固定キュー",
    ...
    readonly property var dynamicText: ({
        ...
        "等待下载": "Waiting",
        "已删除": "Deleted",
        "本地文件已删除": "Local files deleted",
        "等待可用下载槽": "Waiting for an available download slot",
        "并行下载任务": "Active Downloads",
        "动态并行块": "Dynamic Blocks",
        "自动调整": "Auto Tune",
        "固定队列": "Fixed Queue",
        "不良块": "Poor",
        "未知": "Unknown",
